...
namespace vbm
{
    ...
    {
        public async Task<internal_contact> get_user_gifts_bmls(int channel, string username, long userid)
        {
            try
            {
                string url = $"{input_data.user_gifts_url}?channel={channel}&sdt={username}&userid={userid}";
