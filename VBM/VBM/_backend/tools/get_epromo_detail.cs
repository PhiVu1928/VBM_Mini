...
namespace vbm
{
    ...
    {
        public async Task<internal_contact> get_promo_detail(int channel, int shopid, int promoid)
        {
            try
            {
                string url = input_data.promo_detail_url + $"?channel={channel}&shopid={shopid}&promoid={promoid}";
